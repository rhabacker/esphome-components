...
import esphome.components.output as op
...
ntcsim_ns = cg.esphome_ns.namespace("ntcsimulation")
NTCSimulationComponent = ntcsim_ns.class_("NTCSimulation", cg.Component)
...
CONFIG_SCHEMA = (
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(NTCSimulationComponent),
            cv.Optional(CONF_OUTPUT): cv.use_id(op.FloatOutput),
